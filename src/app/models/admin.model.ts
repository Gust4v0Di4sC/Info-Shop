...
export const ADMIN_ROLE_ACCESS: Record<AdminRole, string[]> = {
  ...
  gerente_regional: ['/dash', '/products', '/orders', '/stock', '/deliveries', '/offers', '/clients', '/customization', '/admin-profile'],
...
export function normalizeAdminRole(role: string | null | undefined): AdminRole {
  return role === 'vendedor' || role === 'estoquista' || role === 'gerente_regional' ? role : 'gerente';
}
